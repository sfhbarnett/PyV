...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(30, 20, 164, 152))
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.autocontrast)
        ...
        self.alignmentbutton.setGeometry(QtCore.QRect(0, 10, 113, 32))
        self.alignmentbutton.setObjectName("alignmentbutton")
        self.orientationbutton = QtWidgets.QPushButton(self.tab_2)
        self.orientationbutton.setGeometry(QtCore.QRect(120, 10, 113, 32))
        self.orientationbutton.setObjectName("orientationbutton")
        self.pushButton_3 = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_3.setGeometry(QtCore.QRect(0, 40, 113, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Alignment"))
