...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 20, 200, 311))
        ...
        self.showimagecheck = QtWidgets.QCheckBox(self.formLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.showimagecheck.setText("")
        self.showimagecheck.setChecked(True)
        self.showimagecheck.setObjectName("showimagecheck")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.showimagecheck)
        self.label_7 = QtWidgets.QLabel(self.formLayoutWidget)
        self.label_7.setObjectName("label_7")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_7)
        self.fieldcolormapinput = QtWidgets.QComboBox(self.formLayoutWidget)
        self.fieldcolormapinput.setObjectName("fieldcolormapinput")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.fieldcolormapinput)
        self.runPIVbutton = QtWidgets.QPushButton(self.tab)
        self.runPIVbutton.setGeometry(QtCore.QRect(60, 450, 113, 32))
        ...
        self.linearisebutton = QtWidgets.QPushButton(self.tab_2)
        self.linearisebutton.setGeometry(QtCore.QRect(20, 270, 131, 32))
        self.linearisebutton.setObjectName("linearisebutton")
        self.showlinearfield = QtWidgets.QCheckBox(self.tab_2)
        self.showlinearfield.setGeometry(QtCore.QRect(30, 300, 101, 20))
        self.showlinearfield.setObjectName("showlinearfield")
        self.line = QtWidgets.QFrame(self.tab_2)
        self.line.setGeometry(QtCore.QRect(40, 180, 171, 16))
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.rotationalorderbutton = QtWidgets.QPushButton(self.tab_2)
        self.rotationalorderbutton.setGeometry(QtCore.QRect(20, 320, 131, 32))
        self.rotationalorderbutton.setObjectName("rotationalorderbutton")
        self.centerXinput = QtWidgets.QLineEdit(self.tab_2)
        self.centerXinput.setGeometry(QtCore.QRect(20, 200, 41, 21))
        self.centerXinput.setObjectName("centerXinput")
        self.centerYinput = QtWidgets.QLineEdit(self.tab_2)
        self.centerYinput.setGeometry(QtCore.QRect(20, 230, 41, 21))
        self.centerYinput.setObjectName("centerYinput")
        self.label_9 = QtWidgets.QLabel(self.tab_2)
        self.label_9.setGeometry(QtCore.QRect(70, 200, 60, 16))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.tab_2)
        self.label_10.setGeometry(QtCore.QRect(70, 230, 60, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "Show Image"))
